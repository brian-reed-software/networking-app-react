...
export default function Rightbar({ user }) {
  ...
  const handleClick = async () => {
    try {
      if (followed) {
        await axios.put(`https://friends-again-api.herokuapp.com/api/users/${user._id}/unfollow`, {
          userId: currentUser._id,
        });
        dispatch({ type: "UNFOLLOW", payload: user._id });
      } else {
        await axios.put(`https://friends-again-api.herokuapp.com/api/users/${user._id}/follow`, {
          userId: currentUser._id,
        });
